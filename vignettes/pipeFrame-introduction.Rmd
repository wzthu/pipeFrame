...
Developer can select important necessary and frequently used arguments of the steps as the argument of the whole pipeline. Other argument are pass through `...` with `StepName.argumentsName = value` like:
